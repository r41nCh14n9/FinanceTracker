...
| 復華投信 | `fhtrust.com.tw/ETF/trade_list`（下拉選單選擇 ETF） | ❓ 選單背後對應之 URL／查詢參數規則尚未查明 | 中（✅ 第五輪確認：選擇 `00991A` 後可見約 300+ 檔完整持股靜態表格，含證券代號/名稱/股數與資料日期，內容本身無阻擋，僅選單機制待查明） | **Phase 3（觀察名單，因 `00991A` 而納入）** |
